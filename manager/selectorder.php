<?php
	...
	$result=mysqli_query($conn,"SELECT * FROM `order` WHERE order_type='3' AND done='0' AND rest_id='$rest_id' ORDER BY order_time DESC");
	
	//-------------------------------- For audio --------------------------------------
	$num_row=mysqli_num_rows($result);
	if($num_row>$_SESSION['count3']){
		echo "<audio controls autoplay hidden='true'><source src='chat.wav'></audio>";
		
	}$_SESSION['count3']=$num_row;
	//---------------------------------------------------------------------------------
