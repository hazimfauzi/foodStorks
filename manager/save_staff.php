...
<?php
		...
		mysqli_query($conn,"insert into users(first_name,last_name,password,email,level,gender,address,contact,created,modified,status,employer) 
					values('$fname','$lname','$encryptPass','$email','$level','$gender','$address','$contact','$date','$date','Active','$session_id')")
		or die(mysql_error());
		...
		?>
		<script> 
		window.alert("Successful add staff to system");
