  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-sm-12">
        <center>
          <div class="panel panel-title" style="width:300px;background-color: rgba(255, 255, 255, 0.85);">
            <table width="100%">
              <tr>
                <td colspan="3"><center>
                    <h2 style="margin-top:0"><?php echo $rowrest['rest_name'] ?></h2>
                  </center></td>
              </tr>
              <tr>
                <td width="5%"></td>
                <td width="80%"><input class="star starview-5" name="starview" id="starview-5" type="radio"  <?php if( $rowrest['rest_rate']==5 ){echo "checked='checked'"; }  ?> disabled="disabled"/>
                  ...
                  <label class="star starview-1" name="starview" for="starview-1"></label></td>
                <td><font color="#666666" size="-1">(<?php echo $rowrest['total_rate'] ?>)</font></td>
              </tr>
            </table>
          </div>
          <div class="panel-footer" style="width:330px;"> <font color="#666666" size="-1">
            <?php 
							if($rowrest['open'] == 1){
    ...
    <div class="panel panel-success">
      ...
      <div style="overflow-y:auto; overflow-x:hidden; height:280px;">
        <table class="table table-hover" width="100%">
          ...
          <tr>
            <td width="28%" align="center" ><a class="fa fa-plus-circle alert-success" href="restaurant2.php?rest_id=<?php echo $rest_id ?>&amp;table_id=<?php echo $table_id ?>&amp;action=add&amp;id=<?php echo $values["item_id"]; ?>"><span class="text-danger"></span></a> <?php echo $values["item_quantity"]; ?> <a class="fa fa-minus-circle alert-danger" href="restaurant2.php?rest_id=<?php echo $rest_id ?>&amp;table_id=<?php echo $table_id ?>&amp;action=remove&amp;id=<?php echo $values["item_id"]; ?>"><span class="text-danger"></span></a></td>
            <td><?php echo $values["item_name"]; ?></td>
            <td>RM<?php echo number_format($values["item_quantity"] * $values["item_price"], 2); ?></td>
            <td><a class="fa fa-trash-o alert-danger" href="restaurant2.php?rest_id=<?php echo $rest_id ?>&amp;table_id=<?php echo $table_id ?>&amp;action=delete&amp;id=<?php echo $values["item_id"]; ?>"><span class="text-danger"></span></a></td>
          </tr>
          <?php  
					...
					while($rowcat=mysqli_fetch_array($cat_query)){
                      ...
                      <div id="<?php echo $rowcat['cat_id']; ?>">
						...
						while($rowitem=mysqli_fetch_array($item_query)){ ?>
                          <tr>
                            <form method="post" action="restaurant2.php?rest_id=<?php echo $rest_id ?>&amp;table_id=<?php echo $table_id ?>&amp;id=<?php echo $rowitem["item_id"]; ?>">
