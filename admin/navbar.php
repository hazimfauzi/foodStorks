...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
  <div class="navbar-header">
    ...
    <a class="navbar-brand" href="index.php">Food Storks</a> </div>
  <!-- /.navbar-header -->
  ...
  <div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
      <ul class="nav" id="side-menu">
        ...
        <li> <a href="#"><i class="fa fa-user fa-fw"></i> Admin<span class="fa arrow"></span></a>
          <ul class="nav nav-second-level">
            <li> <a href="add_admin.php"><i class="fa fa-plus fa-fw"></i> Add Admin</a> </li>
            <li> <a href="view_admin.php"><i class="fa fa-group fa-fw"></i> View Admin</a> </li>
          </ul>
          <!-- /.nav-second-level --> 
        </li>
        <li> <a href="#"><i class="fa fa-cutlery fa-fw"></i> Restaurant Manager<span class="fa arrow"></span></a>
          <ul class="nav nav-second-level">
            <li> <a href="add_manager.php"><i class="fa fa-plus fa-fw"></i> Add Manager</a> </li>
            <li> <a href="#"><i class="fa fa-filter fa-fw"></i> Approve Manager</a> </li>
            <li> <a href="view_manager.php"><i class="fa fa-group fa-fw"></i> View Manager</a> </li>
          </ul>
          <!-- /.nav-second-level --> 
        </li>
        <li> <a href="#"><i class="fa fa-group fa-fw"></i> User<span class="fa arrow"></span></a>
          <ul class="nav nav-second-level">
            <li> <a href="add_user.php"><i class="fa fa-plus fa-fw"></i> Add User</a> </li>
            <li> <a href="view_user.php"><i class="fa fa-group fa-fw"></i> View User</a> </li>
          </ul>
          <!-- /.nav-second-level --> 
        </li>
      </ul>
